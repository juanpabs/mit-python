...
def check_compute_cost_function():
    ...
    # x = [[1, 80, 35, 79, 90, 77, 23, 91, 98,  7,  6],
    #      [1, 82, 20,  7, 20, 79, 56, 65, 80, 10, 26],
    #      [1, 67, 46, 24, 54, 74,  2, 28, 11, 16, 34],
    #      [1, 53, 24, 97, 59, 25, 93,  5, 45, 56, 97],
    #      [1, 48, 24, 38, 32, 50, 50, 64, 32, 97, 22],
    #      [1, 96, 56, 30, 85, 23,  4, 33, 17, 15,  7],
    #      [1, 95, 99, 44, 72, 90, 56, 90, 44, 15, 67],
    #      [1, 29, 81, 91, 86, 28, 81, 69, 40, 45, 75],
    #      [1, 33, 78, 19, 17, 51, 22, 11, 90, 86, 97],
    #      [1, 84,  7, 97, 16, 82, 71, 42,  6, 13, 29]]  
